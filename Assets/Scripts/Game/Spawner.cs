...
public class Spawner : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Si el mouse está sobre un elemento de UI (paneles, sliders, botones),
        // no procesar clicks de spawn/destroy — evita que el click "atraviese" el panel.
        ...
        if (!pointerOverUI && Input.GetMouseButtonUp(0) && !Input.GetKey(KeyCode.LeftShift) && !Input.GetKey(KeyCode.LeftAlt))
        {
        ...
        else if (!pointerOverUI && Input.GetKey(KeyCode.LeftShift) && Input.GetMouseButtonUp(0))
        {
            RaycastHit hit;
